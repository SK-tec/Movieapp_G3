        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5">
          <div class="col-lg-3 col-md-6 col-xs-12 mb-3">
            ...
            <ul class="nav flex-column">
              ...
              <li class="nav-item mb-2">
                Whether you're a die-hard cinephile or just love to watch a good
                flick every now and then, this is the place for you. Our team of
                passionate movie buffs is here to bring you the latest news,
                reviews, and insights from the world of cinema.
              </li>
            </ul>
          </div>
            ...
            <ul class="nav flex-column">
              <li class="nav-item mb-2">
                <a href="#" class="nav-link p-0 text-muted">
                  {" "}
                  Based on a book <span class="gigispan"> Insightful</span>{" "}
                  Friendship <span class="gigispan"> Spanish language</span>{" "}
                  Hearth-warming <span class="gigispan"> Charming</span> Dark
                  Need a laugh
                  <span class="gigispan"> Based on a true story</span> Funny
                  Independent Violent{" "}
                  <span class="gigispan">Post-apocalyptic</span> Slow-moving
                </a>
              </li>
            </ul>
          </div>
